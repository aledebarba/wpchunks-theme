...
})({"dI24f":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "c5ef0511fadd7811";
...
},{"@swc/helpers/src/_async_to_generator.mjs":"deQNV","@swc/helpers/src/_to_consumable_array.mjs":"FDKEk","regenerator-runtime":"9eZXj","@parcel/transformer-js/src/esmodule-helpers.js":"hyCVi"}],"deQNV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./_array_like_to_array.mjs":"fWQC8","@parcel/transformer-js/src/esmodule-helpers.js":"hyCVi"}],"9eZXj":[function(require,module,exports) {
/**
...
},{}],"3eqW7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function hello_js(params, element) {
    var _params = (0, _slicedToArrayMjsDefault.default)(params, 2), message = _params[0], number = _params[1];
    element.innerHTML = "Js Bundled function hello_js with parameters [ ".concat(message, ", ").concat(number, " ]");
}
/*
 * get parametes from wordpress/php page 
 * and parse into correct js instance call 
*/ (function() {
    document.querySelectorAll("[wpchunk-hello-js]").forEach(function(el) {
        var name = el.dataset.wpchunk.replace("-", "_");
        var instance = parseInt(el.dataset.instance);
        var params = window[name][instance];
        console.log("here->", params.params, el);
        hello_js(params.params, el);
    });
})();

},{"@swc/helpers/src/_sliced_to_array.mjs":"j9Y53","./index.scss":"5HWrY","@parcel/transformer-js/src/esmodule-helpers.js":"hyCVi"}],"j9Y53":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hyCVi"}],"5HWrY":[function() {},{}]},["dI24f","3eqW7"], "3eqW7", "parcelRequireee10")
